 ...
 <div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Sub Variant</a></li>
  ...
  <!-- /.content-header -->
   ...
   <section class="content">
    <div class="container-fluid">
        <form action="{{url('/save-subcategory')}}" method="POST" name="addSubCategory" id="addSubCategory" enctype="multipart/form-data">
            @csrf
      <!-- SELECT2 EXAMPLE -->
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Add Sub Variant</h3>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <select name="category_id" id="category_id" class="form-control select2 {{($errors->any() && $errors->first('category_id')) ? 'is-invalid' : ''}}" style="width: 100%;">
