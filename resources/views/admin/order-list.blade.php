                ...
                <tbody>
                  ...
                  @if($orders->count())
                    ...
                    <tr>
                      ...
                      <td><a href="{{url('/order-details/'.$order->id)}}" target="_blank">{{$order->product->name}}</a></td>
                      <td>{{$order->price}}</td>
                      <td>
                        <select name="status_status" id="{{$order->id}}" class="form-control select2" disabled>
                            <option>-- Select --</option>
                              
                            <option value="1"  {{ 1 == $order->status ? 'selected="selected"' : '' }}>Awaiting confirmation</option>
                            <option value="2"  {{ 2 == $order->status ? 'selected="selected"' : '' }}>Create order/Confirmed</option>
                            <option value="3"  {{ 3 == $order->status ? 'selected="selected"' : '' }}>Goods Ready</option>
                            <option value="4"  {{ 4 == $order->status ? 'selected="selected"' : '' }}>Quality Inspections</option>
