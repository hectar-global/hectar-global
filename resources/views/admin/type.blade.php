 ...
 <div class="content-wrapper">
  ...
  <!-- /.content-header -->
   ...
   <section class="content">
    ...
    <div class="row">
        <div class="col-lg-3 col-6"><p style="padding-left: 10px; font-size: 24px;">Types</p></div>
    </div>
    <div class="container-fluid">
                ...
                <div style="float: left; padding-left:10px;">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div style="font-size: 28px;">{{$type->title}}</div>
                ...
                <div style="padding-left:10px;">
                    ...
                    <div class="row">
                      <div class="col-md-6 col-sm-12">
                        <center><a href="{{ url('/edit-type/'.$product->id.'/'.$type->id) }}"><i class="fa fa-fw fa-edit"></i></a></center>
                        {{-- <center><a href="#"><i class="fa fa-fw fa-edit"></i></a></center> --}}
                      </div>
    
                      <div class="col-md-6 col-sm-12">
                        <a href="#" onclick="deleteType({{$type->id}})"><i class="fa fa-fw fa-trash"></i></a>
