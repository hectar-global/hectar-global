    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12 col-6">
            ...
            <form action="{{url('/update-type/'.request()->route()->id)}}" method="POST" name="updateType" id="updateType" enctype="multipart/form-data">
                @csrf
          <!-- SELECT2 EXAMPLE -->
          <div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                          <label>Title</label>
                          <input type="text" class="form-control" value="{{old('title', $type->title)}}" name="title" id="title" aria-describedby="ptitleHelp" placeholder="Type Title" class="form-control {{($errors->any() && $errors->first('title')) ? 'is-invalid' : ''}}">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea4">Type Description</label>
                            <textarea class="form-control" id="type_description" name="type_description" rows="3">{{$type !="" ? $type->type_description:""}}</textarea>
